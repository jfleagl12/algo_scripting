// Return the sum of all indices of elements of 'arr' that can be paired with one other element to form a sum that
// equals the value in the second argument 'arg'.
